...
async def start(event):
  await event.reply("**SiriusTagger Bot**, Grup veya kanaldaki neredeyse tüm üyelerden bahsedebilirim ★\nDaha fazla bilgi için **/help**'i tıklayın.",
                    buttons=(
                      [Button.url('🌟 Beni Bir Gruba Ekle', 'https://t.me/siriustaggerbot?startgroup=a'),
                      Button.url('📣 Support', 'https://t.me/siriussupport'),
                      Button.url('🚀 Sahibim', 'https://t.me/siriusafk')]
                    ),
                    link_preview=False
                   )
...
print(">> Bot çalıyor merak etme 🚀 @Siriusupport bilgi alabilirsin <<")
